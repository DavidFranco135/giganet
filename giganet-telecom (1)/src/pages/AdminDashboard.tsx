    ...
    <div className="space-y-8">
      <header className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <Link to="/admin/clients" className="px-4 py-2 bg-primary text-white rounded-xl text-sm font-medium hover:bg-primary-dark transition-colors">Novo Cliente</Link>
        </div>
      </header>
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link to="/admin/tickets" className="text-sm text-primary font-medium hover:underline">Ver todos</Link>
        </div>
