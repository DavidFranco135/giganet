          ...
          return (
            <div key={i} className={cn('flex', isMe ? 'justify-end' : 'justify-start')}>
              <div className={cn(
                ...
                {!isMe && <p className="text-[10px] font-bold text-primary mb-1">Suporte GigaNet</p>}
...
export const SupportPage: React.FC = () => {
  ...
  const whatsappUrl = `https://wa.me/5500000000000?text=${encodeURIComponent('Olá, preciso de suporte GigaNet!')}`;
